...
class RetirementSettingsController extends Controller
{
   ...
   public function __construct()
   {
    ...
    public function index()
    {
        ...
        $data = DB::table('retirementaccsettings')->get();
        return view('pages.accounts.settings.retirement')
        ->with(compact('data'));
    }
    ...
    public function store(Request $request)
    {
     ...
     $data = DB::table('retirementaccsettings');
    ...
    public function destroy(Request $request, $id)
    {
         ...
         $data = DB::table('retirementaccsettings')->where('id', $id);
        $key = $arr['key'];
        $result = $data->delete();
