...
class MainSettingsController extends Controller
{
   public function __construct()
   {
    ...
    public function index()
    {
        ...
        $data = DB::table('mainaccsettings')->get();
        return view('pages.accounts.settings.main')
        ->with(compact('data'));
    }
    ...
    public function destroy(Request $request, $id)
    {
         ...
         $data = DB::table('mainaccsettings')->where('id', $id);
        $key = $arr['key'];
        $result = $data->delete();
