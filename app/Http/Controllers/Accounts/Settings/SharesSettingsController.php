...
class SharesSettingsController extends Controller
{
   ...
   public function __construct()
   {
    ...
    public function index()
    {
        ...
        $data = DB::table('sharesaccsettings')->get();
        return view('pages.accounts.settings.shares')
        ->with(compact('data'));
    }
    ...
    public function store(Request $request)
    {
     ...
     $data = DB::table('sharesaccsettings');
    ...
    public function destroy(Request $request, $id)
    {
         ...
         $data = DB::table('sharesaccsettings')->where('id', $id);
        $key = $arr['key'];
        $result = $data->delete();
