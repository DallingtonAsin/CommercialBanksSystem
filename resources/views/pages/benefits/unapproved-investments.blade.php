     ...
     <div class="row">
       <div class="col-lg-3">
        ...
        <strong class="text-info">
          @can('isAdmin') Plannned Investments @endcan
          @can('isMember') Planned Investments @endcan
        </strong>
...
<div class="table-responsive m-b-40">
  <table class="table table-borderless table-data3 unapprovedInvestmentsTable">
    <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-left">
         ...
         <a href="" class="pl-3 trash-btn"
         data-toggle="modal" data-target="#deleteInvestment_{{ $row->id }}"><span class="glyphicon glyphicon-trash  pr-2" ></span>Delete</a>

         <a href="" class="edit-btn pl-3"
         data-toggle="modal" data-target="#approveInvestment_{{ $row->id }}"><span class="fa fa-check-circle pr-2" ></span>Approve</a>
         @endcan
    ...
    <div class="modal-content nunito-font border border-custom-dark rounded-0">
      <div class="modal-header overview-item--c2 text-center">
        <label class="modal-title nunito-font text-white  nunito-font">
          ...
          Update details of a planned investment
        </label>
    ...
    <div class="modal-content nunito-font border border-custom-dark rounded-0">
      <div class="modal-header  overview-item--c2 text-center">
        <h6 class="modal-title nunito-font text-white nunito-font">
          <i class="fa fa-info-circle"></i>
          Details of a planned investment
        </h6>
            ...
            <div class="form-group">
              <div class="text-center">
               <label class="text-danger">
                ...
                planned investment of <span class="text-dark">{{ $row->asset }}</span>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          <div class="text-center">
           <label class="text-danger nunito-font">
            Are you sure you want to approve investment in 
       ...
       <div class="form-group">
         <form action="{{ Route('investment.approve', $row->id)}}" method="post">
          @csrf
          <button type="submit" class="btn overview-item--c2 text-white"  name="ConfirmBtn">Yes</button>
          <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
        </form>
...
<script>
  $(document).ready(function(){
    var title = "List of unapproved investments";
    var table = $('.unapprovedInvestmentsTable');
