      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center">
           <a href="{{ Route('user.changestatus', ['id' => $user->id, 'status' => $user->active, 'name' => $user->name]) }}" class="btn-status  btn overview-item--c2 text-white nunito-font">
             <i class="fa fa-check text-warning bolded"></i> {{__('Activate') }}</a>
           </td>
         </tr>
         @endforeach
